...
modelWeights = '../MyModels/burger_feb17.onnx'
...
#run('../MyModels/WT_efficientdet-lite-salad.tflite',cameraId,640,320,4,False)
...
model='../MyModels/WT_efficientdet-lite-salad.tflite'
camera_id=0
width=640
height=320
num_threads=4
...
while cap.isOpened():
    ...
    detected_frame = cv2.resize(image, (vid_width,vid_height), interpolation = cv2.INTER_AREA)
